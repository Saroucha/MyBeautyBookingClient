...
public class ClientSignupActivity_ventes extends AppCompatActivity {
...
//        progressBar.setVisibility(View.VISIBLE);
    ...
    public void onSignupSuccess() {
        ...
        Intent intent = new Intent(ClientSignupActivity_ventes.this, VentesPriveesActivity.class);
